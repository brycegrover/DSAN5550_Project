...
def basic_checks(df):
    ...
    print("missing ice values?:", df['ice_conc_mean'].isna().any())
    print("missing vessel counts?:", df['vessel_count'].isna().any())
...
def simple_regression(df):
    ...
    print("negative coefficient means vessels appear when ice is lower.")
